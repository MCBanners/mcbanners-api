...
COPY --from=builder /app/apps/bench-runner/package.json ./apps/bench-runner/package.json
COPY --from=builder /app/apps/compat-runner/package.json ./apps/compat-runner/package.json
