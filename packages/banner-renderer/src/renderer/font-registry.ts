...
const FONT_ASSET_KEYS: Record<RendererFontFace, Record<FontWeight, string>> = {
...
const FONT_FAMILY_NAMES: Record<RendererFontFace, Record<FontWeight, string>> = {
 ...
 */
export const registerRendererFonts = (): void => {
 ...
 */
export const resolveFontFamilyName = (fontFace: RendererFontFace, fontWeight: FontWeight): string =>
  FONT_FAMILY_NAMES[fontFace][fontWeight];
