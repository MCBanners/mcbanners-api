...
export const assetKindValues = ["font", "background-template", "sprite"] as const;
export type AssetKind = (typeof assetKindValues)[number];

export const supportedAssetExtensions = [".png", ".ttf"] as const;
...
const asset = (
  ...
  relativePath,
  sha256,
  extension: extname(relativePath) as SupportedAssetExtension,
  required: true,
  byteSize,
...
export const rendererAssetManifest = {
  ...
  assets: [
    asset(
      ...
      435,
      "3e4af017eb080f000270a53f1348f01c828c7daedd840045d4af999f39f6e9ab"
    ),
    asset(
      "background-template",
      "BURNING_ORANGE",
      ...
      357,
      "460c8d2c611f1c0040a261bbc4517082385b5abfd328b3c9f8c78560c91e4dca"
    ),
    asset(
      "background-template",
      "DARK_GUNMETAL",
      ...
      456,
      "2bee94a6ea901955941d89483a8d8bfaff32659e985df9128d7ae3d80472eff6"
    ),
    asset(
      "background-template",
      "LIGHT_MODE",
      ...
      133,
      "da8be4a2a33d43d577c8a7e71f6cd202a5d4f1caf573a3aade362f944b1a91bb"
    ),
    asset(
      "background-template",
      "MALACHITE_GREEN",
      ...
      456,
      "953265a12b12b79707aafab60ccc6b0839f5ca370d6f9dc33c6846d5a452d97d"
    ),
    asset(
      "background-template",
      "MANGO",
      "banner/mango.png",
      328,
      "294c44c01e5a517692551868e27b002468c316dc0ce98a17a878212f2d13470f"
    ),
    asset(
      "background-template",
      "MOONLIGHT_PURPLE",
      ...
      421,
      "cfbedfff2f71553e1db7fc49a0ee6ebcc70511f9823c05b3079e5997c572c631"
    ),
    asset(
      "background-template",
      "ORANGE_RADIAL",
      ...
      5_923,
      "c9889d78af54b933c7ec4f1610dc3b9e91e5de2dc242f7bb017139306ec10d3d"
    ),
    asset(
      "background-template",
      "PURPLE_TAUPE",
      ...
      456,
      "1a4e0a816b025ac8933fb9793e64c1b35628ced2917b2d8fc61b3352ec8e0dcc"
    ),
    asset(
      "background-template",
      "VELVET",
      "banner/velvet.png",
      330,
      "100ad47901f3a74de478d56f5cad1fb418a2d8569d2ec5a9808b281cdcba2d5c"
    ),
    asset(
      "background-template",
      "YELLOW",
      "banner/yellow.png",
      3_525,
      "f8e7957eb1f7ef41cb5bc3caca03d7d58a2b6b7cc2875d35d4845ddb4a892761"
    ),
    ...
    asset(
      ...
      210_128,
      "3cc3cc375448f2570930c5adb6d07f9defa9ceb7d47cb710b859d06a22d4eee6"
    ),
    asset(
      "font",
      ...
      203_952,
      "50e1dcb40298fcfcc21a1ef3cbee9fe9e82709c48ad30ce617472c06a3bd9436"
    ),
    asset(
      "font",
      "MontserratBold",
    ...
    asset(
      ...
      155_972,
      "19df3a425dd6f1ffaa1765b4f76ad5ad4701d73e24c5abfa0c0e50ba139e670d"
    ),
    asset(
      "font",
      "PoppinsRegular",
      ...
      160_292,
      "6eb324da275c57ad131f532ed97148c45b7a8fc7efddfbeae608c4e4b24b364e"
    ),
    asset(
      "font",
      "RalewayBold",
    ...
    asset(
      ...
      1_095,
      "9bc4025bd803794aa9d4af3177dbddc4c9182f379f8db2146674b44cf2a86a7e"
    ),
    asset(
      "sprite",
      ...
      122_943,
      "1bdcc50d96456059b57713272b5cc74258384198b9fd8484111d4b246f747738",
      "fallback logo"
    ),
    asset(
      "sprite",
      ...
      3_693,
      "ad3d41c7e831d3c79fe3392247f61e055044ac53e47c13a475ae4b8784a85bd8",
      "fallback logo"
    ),
    asset(
      "sprite",
      ...
      45_164,
      "520da4c1434e2b7609e6cc1f03f295bd67741040329500b1e7a79b56c8e5b4f0",
      "fallback logo"
    ),
    asset(
      "sprite",
      ...
      13_885,
      "5214633eaeed1a4a551f0a8ec6ad1f379f52d0e7dac3c52728daf66d5941e001",
      "fallback logo"
    ),
    asset(
      "sprite",
      ...
      179_636,
      "75606aafd2ce942f24cb32c70f186999b15114d6f9fcffe0e8ab5d10df709a06",
      "fallback logo"
    ),
    asset(
      "sprite",
      ...
      219,
      "b3cb0bbb63c90c6b47599681052b8c0fb95c85f227e9542fddca985604e3fa50"
    ),
    asset(
      "sprite",
      ...
      9_260,
      "4318af48dbfe0b8d5fdf90d91c805a5070ddf9456f8bb7717f30f43af41b0604",
      "fallback logo"
    ),
    asset(
      "sprite",
      ...
      1_220,
      "394b9c0977fd16eb6eec9b803f733d92ea20391e11952b14ed312ab944bf0694",
      "fallback logo"
    ),
    asset(
      "sprite",
      ...
      262,
      "cdd1cd9c5819b5a0f5c8b92e6612d81fd3d239c17edcc0b5a339ef7452f6736b",
      "rating star"
    ),
    asset(
      "sprite",
      ...
      314,
      "23aef2c63b0345857b1f6e4a8d645905f8a11e7a6a2c0c49480b7e1a3a268974",
      "rating star"
    ),
    asset(
      "sprite",
      ...
      253,
      "f7bf6607c9242f935310878d7350e9589a82591b3b905aea5e045b07cfa7c7e6",
      "rating star"
    )
  ]
...
export const resolveAssetPath = (assetReference: Pick<AssetReference, "relativePath">): string => {
...
export const computeAssetSha256 = async (filePath: string): Promise<string> =>
...
export const validateAssetManifest = (
  manifest: AssetManifest = rendererAssetManifest
): AssetManifest => {
  const issues: string[] = [];
  ...
  for (const assetReference of manifest.assets) {
    ...
    if (
      !supportedAssetExtensions.includes(assetReference.extension) ||
      assetReference.extension !== actualExtension
    ) {
      issues.push(
        `Unsupported or mismatched extension for ${assetReference.key}: ${assetReference.extension}`
      );
    }
  ...
  for (const assetReference of manifest.assets) {
    ...
    try {
      ...
      if (fileStat.size !== assetReference.byteSize) {
        issues.push(
          `Size mismatch for ${assetReference.key}: expected ${String(assetReference.byteSize)}, got ${String(fileStat.size)}`
        );
      }
