import type { FontFace } from "@mcbanners/domain";
 ...
 */
const FONT_FACE_MAP: Record<FontFace, RendererFontFace> = {
...
export const mapFontFace = (fontFace: FontFace): RendererFontFace => FONT_FACE_MAP[fontFace];
