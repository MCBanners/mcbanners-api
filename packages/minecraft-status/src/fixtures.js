...
export const MC_FIXTURE_HYPIXEL = {
    host: "mc.hypixel.net",
    port: 25565,
    version: "1.20.4",
...
export const MC_FIXTURE_NO_ICON = {
    host: "noicon.local",
    port: 25565,
    version: "1.21.0",
...
export const MC_FIXTURE_LONG_MOTD = {
    host: "longmotd.local",
    port: 25565,
    version: "1.20.1",
    ...
    motd: {
        ...
        colorless: "Welcome to our amazing Minecraft server! We have lots of games and activities for you to enjoy. Come join us today!",
        formatted: "Welcome to our amazing Minecraft server! We have lots of games and activities for you to enjoy. Come join us today!"
    }
};
/** Server with unicode characters in name and MOTD. */
export const MC_FIXTURE_UNICODE = {
    host: "unicode.local",
    port: 25565,
    version: "1.19.4",
...
export const MC_STATUS_FIXTURES = {
